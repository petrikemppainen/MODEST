...
#' @param infile File produced by \code{\link{plotKDAG}}.
...
#' infile <- plotKDAG(modest_MCMV, Qdist_MCMV, KDAG)
#' plotHist(modest_MCMV, infile, 4, sort.by=1)

plotHist <- function(modest, infile, K, sort.by=1){
